...
import { StyleSheet, Text, View, SafeAreaView,Platform, ScrollView, TextInput, Pressable, Image,TouchableOpacity,ImageBackground,FlatList } from 'react-native';
...
const HomeScreen = () => {
  ...
  return (
<SafeAreaView style={{ alignSelf: 'stretch',paddingTop: Platform.OS === "android" ? 40 : 0, flex: 1, backgroundColor: "#FFE4B5" }}>
<ScrollView contentContainerStyle={{ paddingHorizontal: 0 }}>
<View style={{ backgroundColor: 'rgba(0, 0, 0, 0.7)', padding: 10, flexDirection: "row", alignItems: "center" }}>
  ...
  <Text style={{ fontSize: 35, fontWeight: "bold", fontFamily: 'Roboto-Bold', color: "#FFF6E0", marginTop: 10 }}>Munchies and Bevvies</Text>
  <View style={{ alignItems: "center" }}>
    <Text style={{ fontSize: 16, color: "#FFF6E0", marginTop: 5 }}>North Poblacion, Bucay, Abra, Philippines</Text> 
  </View>
</View>
</View>
        </ImageBackground>
  ...
  <View style={styles.containertable}>
      <FlatList style={{width:'100%'}}
        ...
        ListHeaderComponent={() => <Text style={styles.header}>Recent Orders</Text>}
      />
    </View>
...
const styles = StyleSheet.create({
  ...
  header: {
    fontSize: 30, textAlign: 'center', fontWeight: "bold", fontFamily: 'Roboto-Bold', marginTop: 40
  },
  row: {
    flexDirection: 'row',
